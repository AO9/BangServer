...
public class QuestionServiceImpl implements QuestionService {
    ...
    @Override
    public Boolean createNewQuestion(QuestionVO experienceVO) {
	...
	@Override
	public List<QuestionVO> getQuestionListByUserid(Integer userid, Integer beginId) {

		return dao.getQuestionListByUserid(userid,beginId);
	}
}
